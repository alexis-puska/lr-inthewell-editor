    ...
    private void initListeners() {
        ...
        chooseFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    filePathField.setText(absolutePathFile);
                    try {
                        levelService.loadLevels(fileService.readJsonFile(new FileInputStream(new File(absolutePathFile))));
                        drawPanel.repaint();
                    ...
                    System.out
                            .println("You chose to open this file: " + fileChooser.getSelectedFile().getAbsolutePath());
                }
            }
        });
        ...
        saveFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                fileService.writeJson(levels, new File(absolutePathFile));
            }
        });
