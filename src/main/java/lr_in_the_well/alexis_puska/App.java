...
public class App extends JFrame {
	...
	private void initComponent() {
		...
		openLoadFileChooser = new JButton("Open");
		openSaveFileChooser = new JButton("Save to");
		loadFileChooser = new JFileChooser(FileSystemView.getFileSystemView().getHomeDirectory());
		loadFileChooserFilter = new FileNameExtensionFilter("Hammerfest JSON level file", "json");
		...
		saveFileChooserFilter = new FileNameExtensionFilter("Hammerfest JSON level file", "json");
		loadFileChooser.setFileFilter(saveFileChooserFilter);
		...
		nextLevelIndexBorder = BorderFactory.createTitledBorder("next level index");
		nextLevelIndexTextField = new JTextField();
		showPlatformLevelPanel = new JPanel();
		showPlatformLevelLayout = new GridLayout();
		showPlatformLevelBorder = BorderFactory.createTitledBorder("show platform");
	...
	private void treatVortexProperties(Vortex vortex) {
		identifiablePropertiesPanel = new VortexPanel(centerPanel, drawPanel, levelService, "Vortex properties",
				vortex);
